...
todo = ['all_lines_Lagache', 'all_lines_de_Looze', 'CO10', 'CO21', 'CO32', 'CO43', 'CO54', 'CO65', 'CO76', 'CO87', 'CI21',  'CI10'] 

for i in [0]:

    if i == 0:
        cube_path = '/data/SIDES/PYSIDES_ORIGINAL_OUTPUTS/CUBES/pySIDES_from_original_mmIME_'
    ...
    if i ==0:
        pickle_file_name = 'Pk_results_mmIME.p'
